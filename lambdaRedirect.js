'use strict';
// This Lambda @ Edge example demonstrates a redirect that fires in repsonse to a Viewer Request
...
exports.handler = (event, context, callback) => {
    ...
    // If /s3path was specified, redirect to S3, else redirect to the default
